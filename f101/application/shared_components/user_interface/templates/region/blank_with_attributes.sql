...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4331697191731013)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4331974042731013)
,p_plug_template_id=>wwv_flow_imp.id(4331697191731013)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4332252568731013)
,p_plug_template_id=>wwv_flow_imp.id(4331697191731013)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4332594005731013)
,p_plug_template_id=>wwv_flow_imp.id(4331697191731013)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4332887129731013)
,p_plug_template_id=>wwv_flow_imp.id(4331697191731013)
,p_name=>'Sub Regions'
