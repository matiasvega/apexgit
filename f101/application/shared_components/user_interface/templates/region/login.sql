...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4306220668731005)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4306511970731005)
,p_plug_template_id=>wwv_flow_imp.id(4306220668731005)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4306846346731005)
,p_plug_template_id=>wwv_flow_imp.id(4306220668731005)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4307184112731005)
,p_plug_template_id=>wwv_flow_imp.id(4306220668731005)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4307469874731005)
,p_plug_template_id=>wwv_flow_imp.id(4306220668731005)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4307745497731005)
,p_plug_template_id=>wwv_flow_imp.id(4306220668731005)
,p_name=>'Sub Regions'
