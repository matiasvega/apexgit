...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4271462072730994)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4271715531730994)
,p_plug_template_id=>wwv_flow_imp.id(4271462072730994)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4272016695730994)
,p_plug_template_id=>wwv_flow_imp.id(4271462072730994)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4272353161730994)
,p_plug_template_id=>wwv_flow_imp.id(4271462072730994)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4272644020730994)
,p_plug_template_id=>wwv_flow_imp.id(4271462072730994)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4272974103730994)
,p_plug_template_id=>wwv_flow_imp.id(4271462072730994)
