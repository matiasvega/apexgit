...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4298344245731002)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4298631758731002)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4298921088731002)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4299276022731003)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4299508601731003)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4299879858731003)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4300104062731003)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4300400551731003)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4300758200731003)
,p_plug_template_id=>wwv_flow_imp.id(4298344245731002)
,p_name=>'Sub Regions'
