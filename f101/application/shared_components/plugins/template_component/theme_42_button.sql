...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4403452004731081)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4403769361731082)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4404086584731083)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4404326539731083)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4404686595731083)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4404953394731083)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4405201440731084)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4405511319731084)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4405882240731084)
,p_plugin_id=>wwv_flow_imp.id(4403452004731081)
,p_attribute_scope=>'COMPONENT'
