...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4267235806730992)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4267584435730993)
,p_plug_template_id=>wwv_flow_imp.id(4267235806730992)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4267881632730993)
,p_plug_template_id=>wwv_flow_imp.id(4267235806730992)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4268195018730993)
,p_plug_template_id=>wwv_flow_imp.id(4267235806730992)
,p_name=>'Sub Regions'
