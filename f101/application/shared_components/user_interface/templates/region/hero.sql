...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4302736926731004)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4303061842731004)
,p_plug_template_id=>wwv_flow_imp.id(4302736926731004)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4303387267731004)
,p_plug_template_id=>wwv_flow_imp.id(4302736926731004)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4303684221731004)
,p_plug_template_id=>wwv_flow_imp.id(4302736926731004)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4303932834731004)
,p_plug_template_id=>wwv_flow_imp.id(4302736926731004)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4304238657731004)
,p_plug_template_id=>wwv_flow_imp.id(4302736926731004)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
