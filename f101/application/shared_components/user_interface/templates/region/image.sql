...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4256637741730989)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4256906728730989)
,p_plug_template_id=>wwv_flow_imp.id(4256637741730989)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4257212816730989)
,p_plug_template_id=>wwv_flow_imp.id(4256637741730989)
,p_name=>'Sub Regions'
