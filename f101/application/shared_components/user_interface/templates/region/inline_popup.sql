...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4241220736730982)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4241586279730983)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4241815605730984)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4242162550730984)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4242498333730984)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4242776902730984)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4243031375730984)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4243333409730984)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4243681904730984)
,p_plug_template_id=>wwv_flow_imp.id(4241220736730982)
,p_name=>'Sub Regions'
