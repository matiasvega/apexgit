...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4320489283731010)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4320756469731010)
,p_plug_template_id=>wwv_flow_imp.id(4320489283731010)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4321032131731010)
,p_plug_template_id=>wwv_flow_imp.id(4320489283731010)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4321360977731010)
,p_plug_template_id=>wwv_flow_imp.id(4320489283731010)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4321642594731010)
,p_plug_template_id=>wwv_flow_imp.id(4320489283731010)
,p_name=>'Sub Regions'
