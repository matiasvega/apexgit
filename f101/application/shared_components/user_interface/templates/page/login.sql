...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(4221184517730975)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4221491647730975)
,p_page_template_id=>wwv_flow_imp.id(4221184517730975)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4221701854730975)
,p_page_template_id=>wwv_flow_imp.id(4221184517730975)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4222047006730975)
,p_page_template_id=>wwv_flow_imp.id(4221184517730975)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4222317695730975)
,p_page_template_id=>wwv_flow_imp.id(4221184517730975)
,p_name=>'Body Footer'
