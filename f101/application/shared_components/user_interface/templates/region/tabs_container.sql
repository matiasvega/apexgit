...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4317899223731009)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4318143869731009)
,p_plug_template_id=>wwv_flow_imp.id(4317899223731009)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4318423974731009)
,p_plug_template_id=>wwv_flow_imp.id(4317899223731009)
,p_name=>'Tabs'
