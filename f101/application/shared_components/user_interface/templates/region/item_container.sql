...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4249558687730987)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4249807605730987)
,p_plug_template_id=>wwv_flow_imp.id(4249558687730987)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4250197482730987)
,p_plug_template_id=>wwv_flow_imp.id(4249558687730987)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4250449567730987)
,p_plug_template_id=>wwv_flow_imp.id(4249558687730987)
,p_name=>'Button Start'
