...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4246836544730986)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4247143345730986)
,p_plug_template_id=>wwv_flow_imp.id(4246836544730986)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4247499662730986)
,p_plug_template_id=>wwv_flow_imp.id(4246836544730986)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4247788125730986)
,p_plug_template_id=>wwv_flow_imp.id(4246836544730986)
,p_name=>'Sub Regions'
