...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4278085035730996)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4278340378730996)
,p_plug_template_id=>wwv_flow_imp.id(4278085035730996)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4278644858730996)
,p_plug_template_id=>wwv_flow_imp.id(4278085035730996)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4278956654730996)
,p_plug_template_id=>wwv_flow_imp.id(4278085035730996)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4279246892730996)
,p_plug_template_id=>wwv_flow_imp.id(4278085035730996)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4279582306730996)
,p_plug_template_id=>wwv_flow_imp.id(4278085035730996)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4279872799730996)
,p_plug_template_id=>wwv_flow_imp.id(4278085035730996)
,p_name=>'Sub Regions'
