...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4252094957730987)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4252356131730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4252649185730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4252991137730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4253256998730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4253547216730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4253855065730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4254159049730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4254446346730988)
,p_plug_template_id=>wwv_flow_imp.id(4252094957730987)
,p_name=>'Sub Regions'
