...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4388255362731044)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4388572592731051)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4388836805731052)
,p_plugin_attribute_id=>wwv_flow_imp.id(4388572592731051)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4389202742731053)
,p_plugin_attribute_id=>wwv_flow_imp.id(4388572592731051)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4389650505731053)
,p_plugin_attribute_id=>wwv_flow_imp.id(4388572592731051)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4390048485731053)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(4388572592731051)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4390379489731054)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4390698241731054)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4390910214731055)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4391240451731055)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4391551392731055)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391240451731055)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4391905589731059)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391240451731055)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4392377102731059)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391240451731055)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4392717886731059)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391240451731055)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4393163674731060)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4393494500731060)
,p_plugin_attribute_id=>wwv_flow_imp.id(4393163674731060)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4393821259731061)
,p_plugin_attribute_id=>wwv_flow_imp.id(4393163674731060)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4394271679731061)
,p_plugin_attribute_id=>wwv_flow_imp.id(4393163674731060)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4394656936731061)
,p_plugin_attribute_id=>wwv_flow_imp.id(4393163674731060)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4395015941731062)
,p_plugin_attribute_id=>wwv_flow_imp.id(4393163674731060)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4395481572731062)
,p_plugin_attribute_id=>wwv_flow_imp.id(4393163674731060)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4395885848731062)
,p_plugin_attribute_id=>wwv_flow_imp.id(4393163674731060)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4396269359731063)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1804439144416844798)
,p_plugin_id=>wwv_flow_imp.id(4388255362731044)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
